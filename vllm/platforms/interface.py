...
class Platform:
    ...
    def supports_uva(self) -> bool:
        ...
        has_uva_backend = self.is_cuda_alike() or self.is_xpu()
        return has_uva_backend and self.is_pin_memory_available()
    ...
    def has_v2_model_runner_kernels(cls) -> bool:
        ...
        usable. A platform whose runner, sampler and speculator subclasses
        implement the kernel methods themselves returns True."""
